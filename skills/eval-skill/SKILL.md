---
name: eval-skill
description: Evaluate SKILL.md files in a pull request against the M1/M2/M3 rubric and post a review comment with scores. Trigger when the user runs /eval-skill or asks to evaluate a skill file or PR containing a SKILL.md.
---
